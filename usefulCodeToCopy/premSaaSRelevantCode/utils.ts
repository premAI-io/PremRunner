...
export const OpenAIMessageSchema = z.object({
  ...
  name: z
    .string()
    .optional()
    .describe("The name of the function to call, if any."),
  tool_calls: z
    .array(
      z.object({
        ...
        function: z.object({
          ...
          arguments: z
            .string()
            .describe("The arguments to pass to the function as a JSON string"),
        }),
      }),
    )
    .optional()
...
export const OpenAIChatCompletionRequestSchema = z.object({
  messages: z
    ...
    .refine(
      (messages) =>
        !messages.some((msg, index) => msg.role === "system" && index !== 0),
      {
...
export const OpenAIFunctionCallDeltaSchema = z.object({
  arguments: z
    ...
    .optional()
    .describe(
      "The arguments passed to the function in string format, typically JSON-formatted",
    ),
  name: z
    .string()
    .optional()
    .describe("The name of the function being called in this delta update"),
});
...
export const OpenAIToolCallFunctionDeltaSchema = z.object({
  arguments: z
    ...
    .optional()
    .describe(
      "The arguments passed to the tool function, typically provided as a JSON string",
    ),
  name: z
    .string()
    .optional()
    .describe("The name of the tool function being invoked in this delta"),
});
...
export const OpenAIToolCallDeltaSchema = z.object({
  index: z
    .number()
    .int()
    .describe("The position of this tool call in the sequence of tool calls"),
  id: z
    .string()
    .optional()
    .describe("A unique identifier for this specific tool call instance"),
...
export const OpenAIChoiceDeltaSchema = z.object({
  content: z
    .string()
    .optional()
    .describe("The actual text content generated in this delta update"),
  ...
  refusal: z
    .string()
    .optional()
    .describe("Any refusal message if the model declines to respond"),
  role: z
...
export const OpenAIStreamingChoiceSchema = z.object({
  delta: OpenAIChoiceDeltaSchema.describe(
    "The incremental update to the completion in this chunk",
  ),
  finish_reason: z
    .enum(["stop", "length", "tool_calls", "content_filter", "function_call"])
    .optional()
    .describe(
      "The reason why the completion stopped, if applicable in this chunk",
    ),
  index: z
    .number()
    .int()
...
export const OpenAIChatCompletionChunkSchema = z.object({
  id: z
    .string()
    .describe("A unique identifier for this streaming completion chunk"),
  choices: z
    .array(OpenAIStreamingChoiceSchema)
    .describe(
      "Array of completion choices in this chunk, typically contains one choice",
    ),
  created: z
    .number()
    .int()
    .describe("Unix timestamp (in seconds) when this chunk was generated"),
  model: z
    .string()
    .describe(
      "The identifier of the model used to generate this completion chunk",
    ),
  object: z
  ...
  system_fingerprint: z
    ...
    .optional()
    .describe(
      "A unique identifier for the system state that generated this chunk",
    ),
  usage: OpenAIUsageSchema.optional().describe(
