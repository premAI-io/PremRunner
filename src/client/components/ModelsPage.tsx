    ...
    <div className="flex flex-col h-full bg-white">
      ...
      <div className="h-[73px] border-b border-stone-200 bg-stone-50 px-6 flex items-center">
        <div className="flex items-center justify-between w-full">
          <h2 className="text-lg font-semibold text-stone-950">Finetuned Models</h2>
        </div>
      </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            {uploading ? (
              <div className="space-y-6">
                ...
                <div>
                  <p className="text-lg font-medium text-stone-950 mb-2">Uploading model...</p>
                  <p className="text-sm text-stone-500 mb-4">{uploadProgress}% complete</p>
          ...
          <div>
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-base font-medium text-stone-950">Available Finetuned Models</h3>
            ...
            {models.length === 0 ? (
              <div className="bg-stone-50 rounded-lg border border-stone-200 p-12 text-center">
                ...
                <p className="text-lg font-medium text-stone-950 mb-1">No finetuned models yet</p>
                <p className="text-sm text-stone-500">Upload your first finetuned model to get started</p>
              </div>
            ) : (
                  ...
                  >
                    <div className="flex items-start justify-between mb-3">
                      <div className="flex-1">
                        <h4 className="font-medium text-stone-950 text-sm mb-1">{model.name}</h4>
                    ...
                    <div className="flex items-center justify-between pt-3 border-t border-stone-100">
                      <p className="text-xs text-stone-400">
                        {new Date(model.uploadedAt).toLocaleDateString('en-US', {
                          month: 'short',
                          day: 'numeric',
                          year: 'numeric'
                        })}
      ...
      {showNameDialog && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-lg shadow-xl max-w-md w-full p-6">
            <h3 className="text-lg font-semibold text-stone-950 mb-4">Name Your Finetuned Model</h3>
